...
// Route::group(['middleware' => ['portal_logger']], function() {
    ...
    // Admin Routes
    Route::group(['middleware' => ['auth', 'role:it|president|evp|vp|avp|coordinator|coordinator-2|manager|ap|approver|tax|finance-gl|audit|tsr']], function () {
        //Schedules
        ...
        Route::group(['middleware' => ['auth', 'role:it|president|evp|vp|avp|coordinator|coordinator-2|manager|ap|approver|tax|finance-gl|audit']], function () {
            ...
            Route::group(['prefix' => '/expenses-report'], function() {
                ...
                Route::get('/receipt-history/{expense_id}', 'ExpenseController@getReceiptHistory');
            });
