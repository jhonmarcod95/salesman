                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody v-if="expenseByTsr.length">
                                    <tr v-for="(expenseBy, e) in expenseByTsr" v-bind:key="e">  
                                        <td v-if='!expenseBy.payments && expenseBy.receipt_expenses && !expenseBy.route_transportation || expenseBy.route_transportation'> <input type="checkbox" name="expenses_id" :value="expenseBy.id" checked="checked"></td>
                                        <td v-else-if="!expenseBy.receipt_expenses && !expenseBy.receipt_expenses" class="text-danger">Receipt unverified</td>
