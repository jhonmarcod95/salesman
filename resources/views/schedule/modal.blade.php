                ...
                <div id="add_mapping_event_schedule">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <h5>Address</h5>
                                {!! Form::text('address', null, ['id' => 'add-address', 'class' => 'form-control', 'rows' => '2', 'maxlength' => '255']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="update_mapping_event_schedule">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <h5>Address</h5>
                                {!! Form::text('address', null, ['id' => 'address', 'class' => 'form-control', 'rows' => '2', 'maxlength' => '255']) !!}
                            </div>
                        </div>
                    </div>
                </div>
